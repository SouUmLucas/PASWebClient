	  ...
	  <ul id="slide-out" class="side-nav">
        ...
        <div id="messages" class="col s12">
            <div class="container">
                ...
                <form action="ChatFile" method="POST" enctype="multipart/form-data">
                    <div class="row">
                    ...
                    <div class="row">
                        <input class="file-path validate" type="file" name="file" value="" width="20" />
                    </div>
                    <div class="row">
        ...
        <div id="training" class="col s12">
            <div class="container">
                ...
                <form action="Trainingfile" method="POST" enctype="multipart/form-data">
                    <input class="file-path validate" type="file" name="aFile" value="" width="20" />
                    <input type="submit" value="salvar-svc" name="operacao" />
                </form>
            </div>
        </div>
        ...
        <div id="ind_messages" class="col s12">
            <div class="container">
                ...
                <div class="row">
                    <form action="Messages" method="post" class="col s12">
                        <div class="row">
                            <div class="input-field col s12">
                                <textarea id="mensagem" name="messagecontent" class="materialize-textarea"></textarea>
                                <label for="mensagem">Mensagem</label>
                            </div>
                        </div>
                        <div class="submit-button">
                            <button name="action" value="create" class="waves-effect waves-light btn-large"><i class="material-icons right">file_upload</i>Salvar</button>
                        </div>
                    </form>
                </div>
            </div>
